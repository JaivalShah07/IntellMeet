...
export default function EditMeetingModal({ isOpen, onClose, onSuccess, meeting }: EditMeetingModalProps) {
  ...
  useEffect(() => {
    if (isOpen && meeting) {
      ...
      setSelectedParticipants(
        meeting.participants?.map((p: any) => typeof p === 'string' ? p : p._id) || []
      );
        ...
        <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gradient-to-r from-sky-500/5 to-indigo-500/5">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Update details for this meeting</p>
            </div>
          </div>
          <button 
            onClick={onClose} 
